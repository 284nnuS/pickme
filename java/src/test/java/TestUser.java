...
class TestUser {
	...
	void testRowMapper() throws Exception {
		List<User> expected = Arrays.asList(new User[] {
				new User(1, "Gavin Anderson", "gavin@xyz.com", "admin", 'M', "", "", new ArrayList<>()),
				new User(2, "Diana Clarkson", "diana@xyz.com", "mod", 'F', "", "" , new ArrayList<>()),
				new User(3, "Gordon Cameron", "gordon@xyz.com", "user", 'M', "", "", new ArrayList<>()),
				new User(4, "Dorothy Chapman", "dorothy@xyz.com", "user", 'F', "", "",new ArrayList<>()),
				new User(5, "Frank Davies", "frank@xyz.com", "user", 'O', "", "",new ArrayList<>()),
				new User(6, "Emma Ellison", "emma@xyz.com", "user", 'O', "", "",new ArrayList<>()),
		});
